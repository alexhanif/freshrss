...
class FreshRSS extends Minz_FrontController {
	...
	public function init(): void {
		...
		if (!FreshRSS_Context::hasSystemConf()) {
			...
			Minz_Error::error(FreshRSS_HttpResponse::HTTP_500_INTERNAL_SERVER_ERROR, $message, false);
			die($message);
		}
	...
	private static function initAuth(): void {
		...
		if (Minz_Request::isPost()) {
			if (!FreshRSS_Context::hasSystemConf() || !(FreshRSS_Auth::isCsrfOk() ||
				...
				self::initI18n();
				Minz_Error::error(FreshRSS_HttpResponse::HTTP_403_FORBIDDEN, ['error' => [_t('feedback.access.denied'), ' [CSRF]']]);
			}
		}
	}
